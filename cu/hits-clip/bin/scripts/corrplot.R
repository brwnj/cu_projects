...
plot1 = ggplot(ct) + geom_point(aes(MCF7estr, MCF7), size=5, family = 'arial') + coord_cartesian(ylim = c(0,24), xlim = c(0,24)) + theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank())
plot2 = ggplot(ct) + geom_point(aes(BT474, MCF7), size=5) + coord_cartesian(ylim = c(0,24), xlim = c(0,24)) + theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank())
plot3 = ggplot(ct) + geom_point(aes(MDA231, MCF7), size=5) + coord_cartesian(ylim = c(0,24), xlim = c(0,24)) + theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor=element_blank())
