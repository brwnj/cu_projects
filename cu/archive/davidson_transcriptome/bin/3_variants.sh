...
# gatk
REALIGNER_TARGET_CREATOR="--analysis_type RealignerTargetCreator --reference_sequence $REFERENCE --input_file $nodups --out $targetintervals -filterRNC"
INDEL_REALIGNER="--analysis_type IndelRealigner --reference_sequence $REFERENCE --input_file $nodups --targetIntervals $targetintervals --out $realigned -filterRNC"
UNIFIED_GENOTYPER="--analysis_type UnifiedGenotyper --input_file $realigned --reference_sequence $REFERENCE --genotype_likelihoods_model BOTH --out $vcf -filterRNC"
