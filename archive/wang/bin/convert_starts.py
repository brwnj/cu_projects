...
# encoding: utf-8
"""
Originally created by Cole Trapnell on 2008-09-19.
...
help_message = '''
This script converts junctions in BED format produced by TopHat to bed6
with exon start, exon stop as the start and stop coordinate.
...
def main(argv=None):
    ...
    try:
        ...
        for line in sys.stdin.readlines():
            ...
            print "%s\t%d\t%d\t%s\t%s\t%s" % (chromosome, left_pos, right_pos, name, score, orientation)
